...
class Forms extends Component {
  ...
  handleSubmit = (e) => {
    ...
    this.setState({ errors: {} }, async () => {
      try {
        await axios.post(`${process.env.REACT_APP_API_URL}/product`, this.state.data);
              ...
              <CardBody>
                <Form method="post" className="form-horizontal" autoComplete="off">
                  <FormGroup row>
                    ...
                    <Col xs="12" md="9">
                      <Input type="text" id="hf-email" name="name" placeholder="Enter Nama..." onChange={this.handleChange} autoComplete="nama" />
                  ...
                  <FormGroup row>
                    ...
                    <Col xs="12" md="9">
                      <Input type="date" id="hf-email" name="tanggal" onChange={this.handleChange} />
